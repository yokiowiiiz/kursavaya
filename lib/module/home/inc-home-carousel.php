					...
					<div class="video-con-container">
						...
						<div class='video-con-right'>
							<div class="video-tx1-description darkmode-txt scale-content-txt-4">
								...
								<h2>Длинный меч(бастард) с Фаталиса</h2>
								<h3>Отличный билд и забег на Нергиганта губителя на длинном мече(бастарде) с Фаталиса. Поясняю за навыки и украшения</h3>
							</div>
						</div>
					</div>
				</div>
